...
x_train, y_train, x_cv, y_cv, x_test, y_test = utils.prepare_dataset('C:/Users/SURFACE/PyCharmMiscProject/c2w3_lab2_data1.csv')
...
x_train, y_train, x_cv, y_cv, x_test, y_test = utils.prepare_dataset('C:/Users/SURFACE/PyCharmMiscProject/c2w3_lab2_data2.csv')
...
# Prepare dataset with randomID feature
x_train, y_train, x_cv, y_cv, x_test, y_test = utils.prepare_dataset('C:/Users/SURFACE/PyCharmMiscProject/c2w3_lab2_data3.csv')
...
file1 = {'filename':'C:/Users/SURFACE/PyCharmMiscProject/c2w3_lab2_data3.csv', 'label': '3 features', 'linestyle': 'dotted'}
file2 = {'filename':'C:/Users/SURFACE/PyCharmMiscProject/c2w3_lab2_data2.csv', 'label': '2 features', 'linestyle': 'solid'}
files = [file1, file2]
...
# Prepare the dataset
x_train, y_train, x_cv, y_cv, x_test, y_test = utils.prepare_dataset('C:/Users/SURFACE/PyCharmMiscProject/c2w3_lab2_data4.csv')
